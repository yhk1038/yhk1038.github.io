...
import pandas as pd
	...
	- 예측값의 상한값과 하한값을 제어해야 하면 `cap`, `floor` 컬럼에 값 지정
...
- 2) Prophet 객체 생성하고 Fit
	...
	- 상한값과 하한값을 설정할 경우엔 Prophet 객체를 생성할 때 growth='logistic' 추가
...
- 3) 미래 Dataframe 생성
	...
	- 1)에서 예측값의 상한값이나 하한값을 설정했으면 동일하게 지정
...
- Modeling Holidays and Special Events
  ...
  'upper_window': 1,
	...
	- 사용하는 방법은 간단, Prophet 객체를 생성할 떄 holidays 인자로 넘기면 됨
